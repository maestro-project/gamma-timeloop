...
if __name__ == '__main__':
    ...
    parser.add_argument('--config_path', type=str, default='./in_config', help='Configuration path, should include arch.yaml and problem.yaml')
    ...
    gamma_timeloop = GammaTimeloopEnv( fitness_obj=fitness, report_dir=opt.report_dir, in_config_dir=opt.config_path,
